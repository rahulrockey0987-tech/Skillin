    ...
    <div className="flex min-h-screen bg-slate-950 text-white">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mt-10">
          ...
          <StatCard title="Rejected" value={stats.rejectedApplications} />
        </div>
        ...
        <div className="grid xl:grid-cols-3 gap-8 mt-10">
          ...
          <div className="bg-slate-900 rounded-2xl p-6">
            ...
            <p className="text-slate-400 mt-4">
              Ask anything about coding, placements, interviews,
              resume building or career guidance.
            </p>
        ...
        {/* Latest Jobs & Recent Applications */}
